...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (registered) {
      setRegisteredMessage('Account created successfully. Please sign in to continue.');
    }
  }, [searchParams]);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const target = redirectTarget || getDashboardPath(payload?.user?.role);
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500">Sign in to continue to your secure dashboard</p>
        </div>
        ...
        <p className="text-center mt-6 text-slate-500 text-sm">
          ...
          <Link to="/select-role" className="text-blue-600 hover:text-blue-700 font-semibold inline-flex items-center gap-1">
            Create Account
